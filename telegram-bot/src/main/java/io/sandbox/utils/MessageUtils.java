...
public class MessageUtils {
    ...
    public void defaultMessage(Update update, TelegramBotService telegramBotService){
        var a =  "Для взаимодействия со мной вы можете " +
        ...
        telegramBotService.sendMessage(update , a);
    }
